...
document.getElementById("saveBtn").addEventListener("click", function () {
    ...
    fetch("https://backend-transporteccss.onrender.com/api/vales")
        ...
        .then((data) => {
            ...
            // Dividir los datos en páginas de 16 elementos cada una
            var pages = [];
            for (var i = 0; i < filteredData.length; i += 16) {
                pages.push(filteredData.slice(i, i + 16));
            }

            // Construir tablas para cada página
            pages.forEach(function (pageData, pageIndex) {
                ...
                pageData.forEach(function (vale) {
                    tableHTML += `
                        <tr>
                            <td>${vale.IdVale}</td>
            ...
            var opt = {
                margin: [10, 10, 20, 10], // Márgenes [top, left, bottom, right]
                filename: "vales.pdf",
            ...
            function addLogoToPDF(pdf) {
                ...
                for (var i = 1; i <= totalPages; i++) {
                    ...
                    if (i === 1) {
                        // Posicionar el logo en la esquina superior izquierda solo en la primera página
