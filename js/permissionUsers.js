...
async function getUserPermission() {
  try {
    ...
    document
      .querySelector("#addNewPermission")
      .addEventListener("click", () => {
        ...
        document.querySelector("#rolSelect").addEventListener("change", () => {
          ...
          const filteredForms = forms.filter(
            (form) => !excludedForms.has(form.Formulario)
          );
      ...
      if (form) {
        ...
        row.innerHTML = `
                    ...
                    <td class="text-center">
                        ${
                          roleName !== "Admin"
                            ? `<button class="btn btn-outline-danger btn-sm" onclick="DeletePermiso(${role.IdRol})"><i class="bi bi-trash"></i></button>`
                            : ""
                        }
                    </td>
                `;
